...
execute as @p[x=7,y=94,z=7,dx=1,dy=1,dz=1,scores={readytogetitems=1}] run give @s splash_potion{display:{Name:'{"text":"Speed"}'},CustomPotionEffects:[{Id:1,Duration:200}]} 2
execute as @p[x=7,y=94,z=7,dx=1,dy=1,dz=1,scores={readytogetitems=1}] run give @s splash_potion{display:{Name:'{"text":"Strength"}'},CustomPotionEffects:[{Id:5,Duration:200}]} 2
execute as @p[x=7,y=94,z=7,dx=1,dy=1,dz=1,scores={readytogetitems=1}] run give @s splash_potion{display:{Name:'{"text":"Jump"}'},CustomPotionEffects:[{Id:8,Duration:200}]} 2
