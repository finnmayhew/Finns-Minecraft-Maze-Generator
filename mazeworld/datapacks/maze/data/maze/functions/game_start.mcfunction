...
execute if score #maze starttimer matches 1 run scoreboard objectives setdisplay sidebar numkeys

execute if score #maze starttimer matches 1 run scoreboard players set @a readytogetitems 1
